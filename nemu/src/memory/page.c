...
PTE page_read(lnaddr_t addr){
	...
	Assert(page_table_entry.present==1,"page_table_entry is not valid! addr = 0x%x,page_frame=0x%x,page_table_entry=0x%x",addr,dir_entry.page_frame,page_table_entry.val);
